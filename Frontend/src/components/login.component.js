...
class Login extends Component {
  ...
  onChangeUsername(e) {
    let usernameValid = e.target.value.length>3 ? true : false; 
  ...
  onChangePassword(e) {
    let passwordValid = e.target.value.length>3 ? true : false; 
          ...
          >
            ...
            <div className="form-group">
              <div style={{ display: 'flex', justifyContent: 'center' , padding : '5px'}}>
                  <button className="btn btn-dark btn-block my-3 " disabled={this.state.loading} disabled={this.state.submitDisabled}>
                    {this.state.loading && (
                      <span className="spinner-border spinner-border-sm"></span>
                    )}
                    <span>Login</span>
                  </button>
                  <Link to="/register" className="btn btn-outline-dark my-3 mx-2">Register</Link>
              </div>
            </div>
